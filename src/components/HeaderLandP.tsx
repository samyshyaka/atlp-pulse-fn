...
const HeaderLandP = () => {
  ...
  return (
    <div className="w-screen h-[60px] bg-white border-b">
      <div className="px-2 flex justify-between items-center w-full h-full">
        ...
        <div className="hidden lg:flex">
          ...
          <button className="border-none w-24 h-10 mr-4 cursor-pointer">
            Sign In
          </button>
          <button className="px-4 py-2 h-10 bg-transparent cursor-pointer text-sky-600">
      ...
      <ul
        className={
          !nav
            ? 'hidden'
            : 'absolute bg-zinc-200 w-1/8 justify-end px-8 cursor-pointer lg:hidden'
        }
      >
